...
export default function Pagination({ page, setPage, totalPages }: Props) {
  ...
  return (
    <div className='mt-6 flex flex-wrap justify-center'>
      <button className='mx-2 rounded border bg-white px-3 py-2 shadow-sm'>Prev</button>
      {renderPagination()}
      <button className='mx-2 rounded border bg-white px-3 py-2 shadow-sm'>Next</button>
    </div>
  )
}
